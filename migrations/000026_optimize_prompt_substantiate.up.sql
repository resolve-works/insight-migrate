...
BEGIN
    ...
    CREATE OR REPLACE FUNCTION substantiate_prompt(prompt_id bigint, amount int)
    ...
    BEGIN
        ...
        -- Size of the dynamic candidate list for embedding index
        ...
        SELECT prompt_id, p.id as page_id, -1 * (p.embedding <#> prompt_embedding) AS similarity
            FROM pages p
